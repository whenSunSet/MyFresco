...
import static com.facebook.drawee.drawable.impl.ScalingUtils.*;

/**
 * 通过{@link ScaleType}将被代理的drawable 进行缩放以适配View
...
public class ScaleTypeDrawable extends ForwardingDrawable {
    ...
    private void configureBoundsIfUnderlyingChanged() {
        ...
        if (mScaleType instanceof ScalingUtils.StatefulScaleType) {
            Object state = ((ScalingUtils.StatefulScaleType) mScaleType).getState();
