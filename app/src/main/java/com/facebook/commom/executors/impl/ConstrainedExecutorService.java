...
/**
 * 一个代理已经存在的{@link Executor}的{@link java.util.concurrent.ExecutorService}
 * 但是其通过预先的设置来约束当前执行的task
...
public class ConstrainedExecutorService extends AbstractExecutorService {
    ...
    /**
     * 一个创建{@code ConstrainedExecutorService}的工厂，基于{@link LinkedBlockingQueue}
    ...
    /**
     * 一个私有的class，其可以不断的从work队列中移除task并且运行它，
     * 这个class是没有状态的，所以这个单例可能会被提交多次
