...
/**
 * 这是一个代理Drawable，可以用来代理绘制其他的android库中的drawable，这个drawable通过一些
 * public和protected类 暴露了一些操作给 client。
...
public class ForwardingDrawable extends Drawable
    ...
    /**
     * 这个矩阵被用来储存临时的变化，Drawable 需要在UI线程中使用这个功能
    ...
    /**
     * 设置一个新的drawable，用来作为实际的绘制drawable，返回老的drawable
