 ...
 * image formats.
 *
 * 选项中还包含了是否旋转可以被推迟到渲染bitmap的时候。这将被设置为false，
 * 如果是一个后台的线程去使用操作这个bitmap,但是一般是true，特别是使用drawee的时候
...
public class RotationOptions {
    ...
    /**
     * 创建一个新的旋转options给JPEG，在加载的时候不使用任何角度
