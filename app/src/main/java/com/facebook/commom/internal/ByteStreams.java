...
import static com.facebook.commom.internal.Preconditions.checkNotNull;
/**
 * 提供一个实用的方法对byte和I/O stream进行操作
...
public final class ByteStreams {
    ...
    /**
     * 将一个input stream中的byte拷贝到一个output stream中
