...
import com.facebook.commom.internal.Ints;
...
/**
 * 默认的的image个好似检查者，其可以确定 {@link DefaultImageFormats}中的所有格式
...
public class DefaultImageFormatChecker implements ImageFormat.FormatChecker {
     ...
     *
     * 这个决定了从{@link ImageFormatChecker#getImageFormat(InputStream)}中读取多少数据，
     * 在更改了算法之后，这个值应该被重新编辑
    ...
    /**
     * 试图匹配image头字节和头部大小对每一个已知的image格式。如果任何匹配成功,返回相应的图像格式。
